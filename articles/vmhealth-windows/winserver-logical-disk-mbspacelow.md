...
Logical Disk Megabytes Free Space monitoring includes separate thresholds for system and non-system logical disk volumes in order to properly evaluate available free space.  
